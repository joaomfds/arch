...
# Update tlp.conf
echo "CPU_ENERGY_PERF_POLICY_ON_AC=balance_power" >> /mnt/tlp.d/01-powersave.conf
echo "CPU_ENERGY_PERF_POLICY_ON_BAT=balance_power" >> /mnt/tlp.d/01-powersave.conf
