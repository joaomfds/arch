...
reflector starship stow tailscale yazi zoxide \
...
pavucontrol qt5ct slurp tlp waybar wl-clip-persist wofi xdg-desktop-portal-hyprland
...
nvchad pacseek octopi qt6ct-kde stremio wlogout yay
