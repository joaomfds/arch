...
reflector --threads 10 -c Austria --fastest 3 -p http --sort rate --save /etc/pacman.d/mirrorlist
...
hyprland foot wofi waybar hyprlock hypridle hyprpicker mako pavucontrol blueman brightnessctl \
nwg-drawer nwg-look wmctrl qt5ct qt6ct hyprpolkitagent breeze-icons breeze-gtk wl-clip-persist \
plasma kde-system kate konsole kwalletmanager ark chromium ncdu
